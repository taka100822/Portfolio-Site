...
export const worksData = [
  ...
  },
  {
    ...
    detailedDescription: {
      overview: '修士研究用に制作中のゲーム、実験のため、詳細は伏せます',
      content: '鋭意制作中の3DRPGゲーム（2026年7月現在）',
      role: '個人制作のためすべて',
    },
    features: ['研究用途', 'データ収集機能', 'ゲームログ分析'],
    image: `${BASE}/Image/works/MasterResearch/MasterResearch.png`,
    links: {
    },
  },
  {
