...
export const worksData = [
  {
    ...
    detailedDescription: {
      ...
      gameContent: '通常のモニターと球状のモニター（7枚目）を用いた2画面マルチプレイの協力コミュニケーションゲーム。\nプレイヤーは「ドリームサポーター」として、夢と現実それぞれの立場から住人（NPC）の睡眠を守ります。夢側は眠る人の夢を観察し、異変を検知して現実側に共有します。現実側はその情報をもとに原因を特定し、適切に対処します。2人の連携によって、朝まで快適な眠りを維持することを目指すゲームです。',
  ...
  },
  {
    ...
    detailedDescription: {
      overview: 'アルバイト先のメンバーを誘い、初めて共同でゲーム開発に取り組んだ作品',
      gameContent: '学生8人のチーム「TOMSN」（当時は5人）で制作した3Dアクションゲーム。\nユニークな敵が多数出現するステージを、レーザーを駆使して突き進み、ステージ内のすべての敵を撃破することでクリアとなる、爽快感のあるアクションゲームです。',
      role: '企画立案 \n仕様書作成 \nマネジメント（タスク割り当てやスケジュール調整） \n敵の実装 \nステージ制作 \n一部攻撃に使用するモデルの作成',
    },
    features: ['初の共同ゲーム開発', 'アジャイル開発', 'チーム設立', 'Probuilder'],
  ...
  },
  {
    ...
    detailedDescription: {
      overview: 'インターンシップでフロントエンド開発の技術習得を目的として制作したWebアプリケーション',
      gameContent: 'Nuxt.jsを使用して制作したチャットアプリケーション。\nデータベース連携を行い、ログイン機能を実装し、リアルタイムでチャットすることができます。',
      role: '個人開発のためすべて',
    },
  ...
  },
  {
    ...
    description: '研究室の冷蔵庫内食品・飲料品管理のためのWebアプリケーション',
    detailedDescription: {
      overview: 'フロントエンドの1部分を担当したWebアプリケーション',
      gameContent: '初めてチーム開発で制作した冷蔵庫内の食品・飲料品管理Webアプリケーション。\n商品のバーコードをリーダーで読み込ませることで自動で登録が行われます。主な機能は登録、削除、更新およびリストの表示です。',
      role: '登録モーダルの設計と実装',
    },
